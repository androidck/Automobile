...
import com.auto.mobile.common.util.permission.DefaultRationale;
import com.auto.mobile.common.util.permission.PermissionSetting;
...
public class TextActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSetting = new PermissionSetting(TextActivity.this);
        ...
        AndPermission.with(this)
                ...
                .onDenied(new Action() {
                    ...
                    public void onAction(@NonNull List<String> permissions) {
                        Toast.makeText(TextActivity.this, "授权失败", Toast.LENGTH_SHORT).show();
                        if (AndPermission.hasAlwaysDeniedPermission(TextActivity.this, permissions)) {
